...
async function run(): Promise<void> {
  ...
  try {
    ...
    const tablesToClear = [
      ...
      'compliance_check_results', 'compliance_checklist_items',
      'compliance_actions', 'compliance_findings', 'compliance_audits',
      'compliance_calendar', 'compliance_obligations',
      'tax_proofs', 'hra_declarations', 'form16_distributions', 'form16_records',
      'regulatory_filing_items', 'regulatory_filings', 'statutory_challans',
      'pf_account_entries', 'gratuity_provisions', 'statutory_contributions',
      'minimum_wage_rules', 'statutory_config', 'lwf_state_rules',
      'pt_state_slabs', 'pt_state_rules',
      'pf_claims', 'statutory_nominees', 'employee_statutory', 'statutory_registrations',
